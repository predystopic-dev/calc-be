...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"Note: Use PEMDAS rule for solving mathematical expressions, PEMDAS mean Priority Order for Parentheses, Exponents, Multiplication and Division (from left to right), Addition and Subtraction (from left to right. Parantheses have highest priority, followed by Exponents, Multiplication and Division, and lastly Addition and Subtraction. "
        f"for example,"
        f"Q. 2+3*4"
        f"(3*4) => 12, 2+12 = 14."
        f"Q. 2+3+5*4-8/2"
        ...
        f"4. Analyzing Graphical Math problems, that is word problems represented in drawing form, for eg, cars colliding, trigonometric problems, problems on pythagoras theorem problems, adding runs from cricket wagon wheel etc., these will have a drawing representing some scenario and accompanying information with image, PAY CLOSE ATTENTION TO DIFFERENT COLORS FOR THESE PROBLEMS. You need to return the answer in format as LIST OF ONE DICT [{{expr: given expression, result: calculated answer}}]"
